    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-100 via-slate-50 to-white p-5 md:p-10">
      <div className="mx-auto w-full max-w-6xl">
        ...
        <WarehousesSection
          ...
          onCloseForm={closeForm}
          onSubmit={createAddRowHandler(setWarehouses, closeForm, (data, id) => ({
            id,
            name: String(data.name || ""),
        ...
        <InventorySection
          ...
          onCloseForm={closeForm}
          onSubmit={createAddRowHandler(setInventory, closeForm, (data, id) => ({
            id,
        ...
        <CustomersSection
          ...
          onCloseForm={closeForm}
          onSubmit={createAddRowHandler(setCustomers, closeForm, (data, id) => ({
            id,
            name: String(data.name || ""),
        ...
        <SuppliersSection
          ...
          onCloseForm={closeForm}
          onSubmit={createAddRowHandler(setSuppliers, closeForm, (data, id) => ({
            id,
            name: String(data.name || ""),
